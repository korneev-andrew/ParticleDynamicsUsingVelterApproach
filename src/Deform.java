...
public class Deform
{
    ...
    public void AddParticle(double x,double y)
    {
        ...
        MolecularDynamics.Vx = new double[MolecularDynamics.N + 1];
        MolecularDynamics.Vy = new double[MolecularDynamics.N+ 1];
        MolecularDynamics.ax = new double[MolecularDynamics.N + 1];
        MolecularDynamics.ay = new double[MolecularDynamics.N + 1];
